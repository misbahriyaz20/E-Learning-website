		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navi">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li> <a href="" id="our-location" class="btn-success" data-target="#mymodal" data-toggle="modal">Signup</a></li>
				</ul>
					...
					<div class="left-box">
						...
						<form method="POST" action="registration.php">
							<div class="form-group">
								...
								<button type="submit" id="btn-login" name="submit_user">Sign Up</button>
